...
public interface RetrofitHttpService {
    ...
    @Multipart
    @POST()
    Call<ResponseBody> upload(@HeaderMap Map<String, String> headers, @Url String url, @QueryMap Map<String, String> params, @Part("description") RequestBody description,
