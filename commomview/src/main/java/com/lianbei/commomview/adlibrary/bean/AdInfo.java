...
public class AdInfo implements Parcelable {
    ...
    private List<ADctionInfo> actionInfoList;

    public ADctionInfo getActionInfo() {
        return actionInfo;
    }

    public void setActionInfo(ADctionInfo actionInfo) {
        this.actionInfo = actionInfo;
    }

    public List <ADctionInfo> getActionInfoList() {
        return actionInfoList;
    }

    public void setActionInfoList(List <ADctionInfo> actionInfoList) {
