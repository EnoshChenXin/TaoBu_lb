package com.lianbei.commomview.adlibrary;
...
public class AdManager {
    ...
    List<ADctionInfo> actionInfosList;
    /**
     * 广告弹窗距离两侧的距离-单位(dp)
     */
    ...
    public AdManager(Activity context, List<ADctionInfo> actionInfosList) {
        this.context = context;
        this.actionInfosList = actionInfosList ;
    }
    ...
    private View.OnClickListener imageOnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            ADctionInfo advInfo = (ADctionInfo) view.getTag();
    ...
    public void showAdDialog(final int animType) {
        ...
        if(adAdapter != null){
            adAdapter.notifyDataSetChanged();//add this
            adAdapter = null;
        }
    ...
    class AdAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            View rootView = null;
            try {
                ADctionInfo advInfo = actionInfosList.get(position);
                rootView = context.getLayoutInflater().inflate( R.layout.viewpager_item, null);
                ...
                Uri uri = Uri.parse(advInfo.getWindowUrl ());
