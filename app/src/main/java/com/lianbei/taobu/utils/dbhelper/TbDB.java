...
public class TbDB {
	 ...
	 */
	private static final String DATABASE_NAME = "taobu_db";
	/*
	 ...
	 * Station Table Name
	 */
	private static final String OPT_TABLE = "opt_tb";
	...
	private static final String OPT_KEY_ID = "id";
	private static final String OPT_KEY_OPT_ID = "opt_id";
	private static final String OPT_KEY_OPT_NAME = "opt_name";
	private static final String OPT_KEY_LEVEL = "level";
	private static final String OPT_KEY_PARENT_OPT_ID = "parent_opt_id";
	 ...
	 * @throws SQLException
	 */
	public TbDB open() throws SQLException {
	 ...
	 * @return
	 */
	public long createOptData(String opt_id, String opt_name, String level, String parent_opt_id) {
		ContentValues initialValues = new ContentValues();
		initialValues.put(OPT_KEY_OPT_ID, opt_id);
		initialValues.put(OPT_KEY_OPT_NAME, opt_name);
		initialValues.put(OPT_KEY_LEVEL, level);
		initialValues.put(OPT_KEY_PARENT_OPT_ID, parent_opt_id);
