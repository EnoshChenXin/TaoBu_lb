package com.lianbei.taobu.utils.secureity;
...
//	}
    ...
    public static String encodeDate(){
		if(Validator.isStrNotEmpty ( TimeUtils.getTime ( ) ) ){
			return 	encode(Validator.isStrNotEmpty ( TimeUtils.getTime (  ) )+"");
		}
	  return  encode("2008-01-01 23:59:59");
	}
