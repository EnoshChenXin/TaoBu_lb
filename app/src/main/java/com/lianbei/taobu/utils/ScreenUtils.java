...
public class ScreenUtils {
    ...
    private static void readScreenSize() {
        ...
        WindowManager manager = (WindowManager) GlobalApplication.getApplication ().getSystemService(Context.WINDOW_SERVICE);
        manager.getDefaultDisplay().getMetrics(dm);
        SCREEN_WIDTH = dm.widthPixels;
        SCREEN_HEIGHT = dm.heightPixels;
        boolean isFlag = (GlobalApplication.getApplication ().getResources().getConfiguration().screenLayout & Configuration.SCREENLAYOUT_SIZE_MASK) >= Configuration.SCREENLAYOUT_SIZE_LARGE;
