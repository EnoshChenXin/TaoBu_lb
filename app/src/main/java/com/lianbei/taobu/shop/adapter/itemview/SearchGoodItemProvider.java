...
public class SearchGoodItemProvider extends BaseGoodItemProvider {
    public SearchGoodItemProvider(String channelCode) {
        super ( channelCode );
    }

    @Override
    public int viewType() {
        return BaseGoodListAdatper.COMMON_GOOD;
    }
