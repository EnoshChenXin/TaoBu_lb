...
public class ShopManager {
   ...
   public void  top_goods(RequestCompletion completion,int offset, int limit , String str){
     ...
     * 多多进宝推广链接生成
     */
    public void  PDD_Url_Generate(String goods_id_list,String user_id,RequestCompletion completions,String tag){
        Map<String,Object> map  =new HashMap <> (  );
        ...
        map.put ("custom_parameters",user_id);   //自定义参数，为链接打上自定义标签。自定义参数最长限制64个字节。
