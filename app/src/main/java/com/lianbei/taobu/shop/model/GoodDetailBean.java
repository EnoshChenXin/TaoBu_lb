...
public class GoodDetailBean implements Serializable {
    ...
    private String goods_id;//参与多多进宝的商品ID
    ...
    private ArrayList <String> goods_gallery_urls;// 商品轮播图


    private long min_group_price;//最低价sku的拼团价，单位为分


    private String min_normal_price;//最低价sku的单买价，单位为分


    private String mall_name;//店铺名称


    private String opt_id;//商品标签ID，使用pdd.goods.opt.get接口获取


    private String opt_name; // 商品标签名称


    private List <Integer> opt_ids;//商品标签ID


    private List <Integer> cat_ids;// 商品一~四级类目ID列表


    private String coupon_min_order_amount;//优惠券门槛金额，单位为分
    ...
    private String goods_eval_count;// 商品评价数
    ...
    public void setGoods_gallery_urls(ArrayList <String> goods_gallery_urls) {
